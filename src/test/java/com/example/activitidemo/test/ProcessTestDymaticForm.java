...
public class ProcessTestDymaticForm {
    ...
    private String filename = "E:\\java\\project\\activitiDemo\\src\\test\\java\\com\\example\\activitidemo\\test\\DymaticForm.bpmn";
    ...
    public void startProcess() throws Exception {
        ...
        repositoryService.createDeployment().addInputStream("DymaticForm.bpmn", new FileInputStream(filename)).deploy();
